...
export default function ContributorData({
  ...
  const fetchProfile = async () => {
    try {
      ...
      const x = res?.data?.address?.wallet?.primaryProfile;
  ...
  const formatted = owner ? owner.slice(0, 6) + "..." + owner.slice(39, owner.length) : ""
            ...
            <Box>
              <Text fontSize=
                ...
                fontWeight="semibold">
                {
                  ...
                  i === 4 ? "Explorer" :
                    profile ? profile.handle.split("_")[1] : formatted
                }
